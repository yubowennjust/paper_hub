...
url = 'http://openaccess.thecvf.com//CVPR2014.py'
...
|: 或
'''
#link pattern: href="***_CVPR_2014_paper.pdf">pdf
link_list = re.findall(r"(?<=href=\").+?pdf(?=\">pdf)|(?<=href=\').+?pdf(?=\">pdf)",web_context)
#name pattern: <a href="***_CVPR_2014_paper.html">***</a>
name_list = re.findall(r"(?<=2014_CVPR_paper.html\">).+(?=</a>)",web_context)
print(len(name_list))
import csv
csvfile = open("cvpr14.csv", "a")
