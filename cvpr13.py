...
url = 'http://openaccess.thecvf.com//CVPR2013.py'
...
|: 或
'''
#link pattern: href="***_CVPR_2013_paper.pdf">pdf
link_list = re.findall(r"(?<=href=\").+?pdf(?=\">pdf)|(?<=href=\').+?pdf(?=\">pdf)",web_context)
#name pattern: <a href="***_CVPR_2013_paper.html">***</a>
name_list = re.findall(r"(?<=2013_CVPR_paper.html\">).+(?=</a>)",web_context)

import csv
csvfile = open('cvpr13.csv', 'w')
